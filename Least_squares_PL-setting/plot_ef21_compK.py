...
for k_size_ar_bd in k_size_ar_bd_ar:
    ...
    main_title = f'EF21_CompK_{k_size_ar_bd}_{dataset}_20workers_300K'
    ...
    factor_ar_bd = [1, 4, 8, 16, 32, 64, 128, 256, 512]
    # factor_ar_bd = [64]
    ratio = 1
    ...
    experiment_ar = ["EF21-full-grad_nw-{0}_{1}x_CompK_{2}_True_1".format(n, factor_bd, k) for n, k, factor_bd in
                     itertools.product(n_ar, k_size_ar_bd, factor_ar_bd)]  # #1
    label_ar = ["EF21; k={0}; {1}x".format(k_size, factor_bd) for k_size, factor_bd in
    ...
    filename = "{0}_{1}_{2}.pdf".format(main_title, dataset, ratio)
