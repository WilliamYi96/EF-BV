...
for k_size_ar_bd in k_size_ar_bd_ar:
    ...
    main_title = F"EF22_{dataset}_20workers_300K_MixK"

    # factor_ar = [4,8]
    # factor_ar_bd = [1,2,4,8,16,32,64,128,256,512,1024,2048]
    # factor_ar_bd = [1, 2, 4, 8, 16, 32]
    # factor_ar_bd = [8]
    factor_ar_bd = [1, 8, 16, 32, 64, 128, 256, 512, 1024]
    ...
    experiment_ar = ["EF22-full-grad_nw-{0}_{1}x_MixK_{2}".format(n, factor_bd, k) for n, k, factor_bd in
