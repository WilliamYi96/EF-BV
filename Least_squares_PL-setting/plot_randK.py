...
for k_size_ar_bd in k_size_ar_bd_ar:
    ...
    main_title = f"DIANA_{dataset}_20workers_300K_Rand{k_size_ar_bd[0]}K"
    ...
    experiment_ar = ["DIANA-full-grad_nw-{0}_{1}x_RandK_{2}".format(n, factor_bd, k) for n, k, factor_bd in
