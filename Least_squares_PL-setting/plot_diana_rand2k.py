...
for k_size_ar_bd in k_size_ar_bd_ar:
    ...
    main_title = f'DIANA_Rand2K_{k_size_ar_bd}_{dataset}_20workers_300K'

    # factor_ar = [4,8]
    # factor_ar_bd = [1,2,4,8,16,32,64,128,256,512,1024,2048]
    factor_ar_bd = [1, 4, 8, 16]
    # factor_ar_bd = [8]
    ...
    experiment_ar = ["DIANA-full-grad_nw-{0}_{1}x_RandK_{2}_True_2".format(n, factor_bd, k) for n, k, factor_bd in
                     itertools.product(n_ar, k_size_ar_bd, factor_ar_bd)]  # #1
