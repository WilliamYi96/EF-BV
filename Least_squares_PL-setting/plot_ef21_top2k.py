...
for k_size_ar_bd in k_size_ar_bd_ar:
    ...
    main_title = f'EF21_Top2K_{k_size_ar_bd}_{dataset}_20workers_300K'
    ...
    experiment_ar = ["EF21-full-grad_nw-{0}_{1}x_TopK_{2}_True_2".format(n, factor_bd, k) for n, k, factor_bd in
                     itertools.product(n_ar, k_size_ar_bd, factor_ar_bd)]  # #1
