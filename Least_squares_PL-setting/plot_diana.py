...
for k_size_ar_bd in k_size_ar_bd_ar:
    ...
    main_title = f'DIANA_RandK_{k_size_ar_bd}_{dataset}_20workers_300K'
    ...
    experiment_ar = ["DIANA-full-grad_nw-{0}_{1}x_RandK_{2}_True_1".format(n, factor_bd, k) for n, k, factor_bd in
                     itertools.product(n_ar, k_size_ar_bd, factor_ar_bd)]  # #1
    label_ar = ["DIANA; k={0}; {1}x".format(k_size, factor_bd) for k_size, factor_bd in
