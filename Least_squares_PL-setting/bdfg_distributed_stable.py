...
print(f"L_0 = {L_0}, mu_0 = {mu_0}")  # (10.34), 1.65e-28
...
for i in range(len(n_ar)):
    ...
    if k_ar[0] == d_0:
        ...
        t_ar = -1 + np.sqrt(1 / (1 - al_ar))  # TODO: why "s" (t_ar) was set to be like this?
    ...
    for k in range(len(k_ar)):
        results = biased_diana_top_k_gd(x_0, X, y, X_0, y_0, step_size_diana_tpc[k], eps, la, k_ar[k], n_ar[i],
