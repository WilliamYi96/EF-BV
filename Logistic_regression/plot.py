...
for k_size_ar_bd in k_size_ar:
    ...
    experiment_ar = ["EF22-full-grad_nw-{0}_{1}x_CompK_{2}_True_{3}_{4}".format(n, lr_factor, k_prime, overlap, k) for n, lr_factor, k_prime, overlap, k in
                     itertools.product(n_ar, lr_factor_ar, k_prime_size_ar, overlap_ar, k_size_ar)] +\
                    ["EF21-full-grad_nw-{0}_{1}x_CompK_{2}_True_{3}_{4}".format(n, lr_factor, k_prime, overlap, k) for n, lr_factor, k_prime, overlap, k in
                     itertools.product(n_ar, lr_factor_ar, k_prime_size_ar, overlap_ar, k_size_ar)]
