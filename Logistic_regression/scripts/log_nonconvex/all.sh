...
# noticed that the number of workers has been modified
python compTRk2.py --k 1 --dataset mushrooms --max_it 50000 --tol 1e-7 --factor 1 --num_workers 8124 --method EF21 --compressor CompK --ratio 56 --ind --overlap 1
python compTRk2.py --k 1 --dataset mushrooms --max_it 50000 --tol 1e-7 --factor 1 --num_workers 8124 --method EF22 --compressor CompK --ratio 56 --ind --overlap 1

python compTRk2.py --k 1 --dataset w8a --max_it 50000 --tol 1e-7 --factor 1 --num_workers 49749 --method EF21 --compressor CompK --ratio 150 --ind --overlap 1
python compTRk2.py --k 1 --dataset w8a --max_it 50000 --tol 1e-7 --factor 1 --num_workers 49749 --method EF22 --compressor CompK --ratio 150 --ind --overlap 1

python compTRk2.py --k 1 --dataset phishing --max_it 50000 --tol 1e-7 --factor 1 --num_workers 11055 --method EF21 --compressor CompK --ratio 34 --ind --overlap 1
python compTRk2.py --k 1 --dataset phishing --max_it 50000 --tol 1e-7 --factor 1 --num_workers 11055 --method EF22 --compressor CompK --ratio 34 --ind --overlap 1

python compTRk2.py --k 1 --dataset a9a --max_it 50000 --tol 1e-7 --factor 1 --num_workers 32561 --method EF21 --compressor CompK --ratio 61 --ind --overlap 1
python compTRk2.py --k 1 --dataset a9a --max_it 50000 --tol 1e-7 --factor 1 --num_workers 32561 --method EF22 --compressor CompK --ratio 61 --ind --overlap 1
