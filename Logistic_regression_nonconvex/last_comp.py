...
parser.add_argument('--num_workers', action='store', dest='num_workers', type=int, default=1000,
    ...
    for method in methods:
        for k_ar in kss:
            ...
            if method == 'EF22':
                ...
                theta_ar = ss * (1 + ss) * r / r_av
                gamma = 1. / (L_0 + Lt * np.sqrt(r_av / r) * (1. / ss)) * factor
            print(f'{method}-{ks}-{args.overlap}: {eta}, {omega}, {omega_av}, {lamd_ar}, {nu_ar}, {r}, {r_av}, {np.sqrt(r_av/r)}, {ss}, {gamma}')
